...
import org.example.builder.ingridients.cheese.Cheddar;
...
import org.example.builder.ingridients.protein.Ham;
import org.example.builder.ingridients.protein.Protein;
import org.example.builder.ingridients.vegetable.Mushroom;
...
public class CheddarMexicanPizzaBuilder implements PizzaBuilder{
    Pizza pizza=new Pizza();

    @Override
    public PizzaBuilder buildName() {
        pizza.setName("Cheddar Mexican");
        return this;
    }
    ...
    public PizzaBuilder buildVegetables(){
        ...
        pizza.addVegetable(new Mushroom());
        return this;
    }
    @Override
